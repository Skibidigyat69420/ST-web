    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <span className="text-caption tracking-[0.25em] text-charcoal hover:text-accent transition-colors duration-500">
              SOUND THESIS
            </span>
            <span className="text-[10px] tracking-[0.3em] text-accent uppercase mt-0.5">
              Rx
            </span>
          </a>
