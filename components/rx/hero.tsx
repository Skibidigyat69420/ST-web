  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          ...
          style={{
            y: orbY,
            background:
              "radial-gradient(circle, rgba(15,118,110,0.07) 0%, transparent 65%)",
          }}
          animate={{
            x: [0, 25, 0],
            y: [0, -15, 0],
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(19,78,74,0.04) 0%, transparent 70%)",
          }}
          animate={{
            scale: [1, 1.12, 1],
          }}
        ...
        <motion.div
          ...
          style={{
            background: "linear-gradient(to bottom, transparent, #d9d0c3, transparent)",
          }}
      ...
      >
        ...
        >
          <span className="text-caption tracking-[0.3em] text-accent px-4 py-2 border border-accent/20 rounded-full">
            Rx
          </span>
          <span className="text-caption tracking-[0.2em] text-stone-light">
            Specialist Wealth Management for Medical Professionals
          </span>
        </motion.div>
        ...
        <motion.p
          className="text-body text-stone-light mt-8 max-w-lg mx-auto"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 1.6 }}
        >
          Years of training. Then a sharp income curve. Most medical professionals
          are unprepared for the speed at which wealth accumulates — and the
          complexity that follows. We built this practice for that exact arc.
        </motion.p>
      </motion.div>
